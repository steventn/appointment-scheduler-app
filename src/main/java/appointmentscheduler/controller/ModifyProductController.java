...
/**
 * The controller class that provides logic for the modify product screen of the application.
 *
...
public class ModifyProductController implements Initializable{
    ...
    /**
     * The product object that will be modified.
     */
    ...
    /**
     * The product ID field for the product
     */
    @FXML
    ...
    /**
     * Saves a modified Product object with its associated parts and adds it to the Inventory.
     *
     ...
     * Populates existing product information.
     *
